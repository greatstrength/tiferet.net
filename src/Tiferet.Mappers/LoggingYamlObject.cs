...
/// <summary>Transfer object for <see cref="Formatter"/> in YAML configuration.</summary>
public class FormatterYamlObject : TransferObject<Formatter, FormatterAggregate>
{
    ...
    public override FormatterAggregate Map(Dictionary<string, object?>? overrides = null)
        => new(new Formatter(Id, Name, Format, Description, DateFormat));
...
/// <summary>Transfer object for <see cref="Handler"/> in YAML configuration.</summary>
public class HandlerYamlObject : TransferObject<Handler, HandlerAggregate>
{
    public string Id { get; set; } = "";
    public string Name { get; set; } = "";
    ...
    public override HandlerAggregate Map(Dictionary<string, object?>? overrides = null)
    {
        ...
        return new HandlerAggregate(new Handler(Id, Name, AssemblyName, TypeName, level,
...
/// <summary>Transfer object for <see cref="Logger"/> in YAML configuration.</summary>
public class LoggerYamlObject : TransferObject<Logger, LoggerAggregate>
{
    public string Id { get; set; } = "";
    public string Name { get; set; } = "";
    public string Level { get; set; } = "Information";
    ...
    {
        var level = Enum.TryParse<LogLevel>(Level, true, out var lv) ? lv : LogLevel.Information;
        return new LoggerAggregate(new Logger(Id, Name, level, Description,
