...
/// <summary>
/// Transfer object for <see cref="AppServiceDependency"/> in YAML configuration.
/// </summary>
public class AppServiceDependencyYamlObject : TransferObject
{
    ...
    public AppServiceDependency ToRecord() => new(ServiceId, AssemblyName, TypeName,
        Parameters is not null ? new Dictionary<string, string>(Parameters) : null);

    public static AppServiceDependencyYamlObject FromRecord(AppServiceDependency svc) => new()
    {
...
/// <summary>
/// Transfer object for <see cref="AppInterface"/> in YAML configuration.
/// </summary>
public class AppInterfaceYamlObject : TransferObject<AppInterface, AppInterfaceAggregate>
{
    ...
    {
        var services = Services?.Select(s => s.ToRecord()).ToList() as IReadOnlyList<AppServiceDependency>;
        ...
        var app = new AppInterface(Id, Name, AssemblyName, TypeName, Description,
