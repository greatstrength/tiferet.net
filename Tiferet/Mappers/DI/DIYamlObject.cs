...
/// <summary>Transfer object for <see cref="FlaggedDependencyConfiguration"/> in YAML configuration.</summary>
public class FlaggedDependencyYamlObject : TransferObject
{
    ...
    public FlaggedDependencyConfiguration ToRecord() => new(Flag, AssemblyName, TypeName,
        Parameters is not null ? new Dictionary<string, string>(Parameters) : null);

    public static FlaggedDependencyYamlObject FromRecord(FlaggedDependencyConfiguration dep) => new()
    {
    ...
    public override Dictionary<string, object?> ToDictionary(string? role = null, Dictionary<string, object?>? overrides = null)
    {
        ...
        {
            ["Flag"] = Flag, ["AssemblyName"] = AssemblyName, ["TypeName"] = TypeName,
        };
